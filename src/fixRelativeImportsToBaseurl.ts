...
import { commentErraneousImports, fixImportsInAllFiles } from './file';
...
export class FixRelativeImportsToBaseurlProvider {
  ...
  public async fixOne(): Promise<void> {
    ...
    await fixImportsInDocument(baseUrlWithTrailingSlash, []);
  }
  ...
  public commentAllErraneousImports(): void {
    commentErraneousImports(this.workspaceRoot || '', '');
  }
